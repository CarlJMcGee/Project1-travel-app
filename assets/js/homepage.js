...
var weatherInfoHandler = ({ tp, hu, ws }, { aqius, mainus }) => {
  $(weatherContainer).empty();
  var cToF = (tp * 9) / 5 + 32;
  var tempEl = document.createElement("p");
  tempEl.className = "temp m-4";
  tempEl.innerHTML = cToF + "℉";
  weatherContainer.append(tempEl);

  var humidityEl = document.createElement("p");
  humidityEl.className = "humidity m-4";
  humidityEl.innerHTML = hu + "%";
  weatherContainer.append(humidityEl);

  var windspeedEl = document.createElement("p");
  windspeedEl.className = "windspeed m-4";
  windspeedEl.innerHTML = ws + "M/s";
  weatherContainer.append(windspeedEl);

  var AQIel = document.createElement("p");
  AQIel.className = "aqi m-4";
  AQIel.innerHTML = aqius;
  weatherContainer.append(AQIel);

  var pollutantEl = document.createElement("p");
  pollutantEl.className = "mainus m-4";
  pollutantEl.innerHTML = mainus;
  weatherContainer.append(pollutantEl);
};
...
$(cityContainer).submit(function (e) {
  e.preventDefault();
